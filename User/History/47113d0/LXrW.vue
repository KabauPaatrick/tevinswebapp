          ...
          <form @submit.prevent="submitHomeView" class="form">
            ...
            <div class="row mt-3">
              <div class="col-md-12 d-flex justify-content-between">
                ...
                <button type="button" class="btn btn-primary" @click="updateHomeView">Update</button>
              </div>
            </div>
          </form>
        </div>
    ...
    setup() {
      ...
      const updateHomeView = async () => {
        try {
          ...
          const response = await axios.put(`http://127.0.0.1:8000/api/homeview/${homeView.id}/update/`, formData, {
            headers: {
              'Content-Type': 'multipart/form-data',
            },
          });
