                    ...
                    <div class="row mt-3">
                        <div class="col-md-12 d-flex justify-content-between">
                            ...
                            <button type="button" class="btn btn-primary"
                                @click="updateAchievement()">Update</button>
                        </div>
                    </div>
                </form>
            </div>
...
export default {
    ...
    try {
        ...
        const updateAchievement = async (selectedAchievement) => {
    try {
        const response = await axios.put(`http://127.0.0.1:8000/api/achievement/${selectedAchievement.id}/update/`, achievement);
        console.log(response.data);
        fetchAchievements();
    } catch (error) {
