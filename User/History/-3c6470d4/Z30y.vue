        ...
        <div class="customer-form">
            <form @submit.prevent="submitCustomer" class="form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="website" v-model="customer.website" class="form-input" required>
                </div>
                <div class="form-group">
                        <label for="createdBy" class="form-label">Created By:</label>
                        <input type="text" id="createdBy" v-model="customer.createdBy" class="form-input" required>
                    </div>
                    <div class="form-group">
                        <label for="createdAt" class="form-label">Created At:</label>
                        <input type="datetime-local" id="createdAt" v-model="customer.createdAt" class="form-input"
                            required>
                    </div>
                    <div class="form-group">
                        <label for="updatedAt" class="form-label">Updated At</label>
                        <input type="datetime-local" id="updatedAt" v-model="customer.updatedAt" class="form-input"
                            required>
                    </div>
