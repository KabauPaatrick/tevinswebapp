...
export default {
    setup() {
        ...
        onMounted(() => {
            ...
            return { entity, testimonial, homeView, achievement, solution, entities, customers, submitHomeView, submitAchievement, submitSolution, handleImageUpload, submitTestimonial, submitEntity };
