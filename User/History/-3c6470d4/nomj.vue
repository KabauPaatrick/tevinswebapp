<template>
    ...
    <form @submit.prevent="submitCustomer" class="form">
      ...
      <div class="form-group">
        <label for="createdAt" class="form-label">Created At:</label>
        <input type="datetime-local" id="createdAt" v-model="customer.createdAt" class="form-input" required>
      </div>
      <div class="form-group">
        <label for="updatedAt" class="form-label">Updated At</label>
        <input type="datetime-local" id="updatedAt" v-model="customer.updatedAt" class="form-input" required>
      </div>
      ...
      <!-- Delete Button -->
      <button type="button" class="btn-delete" @click="deleteCustomer">Delete</button>

      <!-- Update Button -->
      <button type="button" class="btn-update" @click="updateCustomer">Update</button>
      </div>
    </form>
  </div>
    </div>
    ...
    setup() {
        ...
        const submitCustomer = async () => {
            try {
                ...
                formData.append('created_by', customer.createdBy); // Use createdBy from solution object
                formData.append('created_at', customer.createdAt);
                formData.append('updated_at', customer .updatedAt);
...
.btn-submit {
  width: auto; /* Set the width to auto to make it the same size as the other buttons */
}
