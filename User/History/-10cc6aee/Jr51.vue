...
export default{
    setup(){
        ...
        onMounted(() => {
            ...
            return { entity, testimonial,  achievement, solution, entities, customers, submitHomeView, submitAchievement, submitSolution, handleImageUpload, submitTestimonial, submitEntity, customer, submitCustomer };
