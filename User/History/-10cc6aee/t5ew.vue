  ...
  export default {
    setup() {
      ...
      const updateTestimonialForm = (selectedTestimonial) => {
        ...
        testimonial.testimonialImage = selectedTestimonial.testimonialImage;
      ...
      const updateTestimonial = async (id) => {
        try {
          ...
          const response = await axios.put(`http://127.0.0.1:8000/api/testimonials/${id}/update/`, formData, {
            headers: {
              'Content-Type': 'multipart/form-data'
            }
          });
