      ...
      <div class="card-body">
        <form @submit.prevent="submitSolution" class="form">
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-6">
              <button type="submit" class="btn btn-primary" @click="updatSolutiononSubmit">Update-Solution</button>
            </div>
          </div>
...
export default {
  setup() {
    ...
    return {
      ...
      deleteSolution,
      updateSolutionForm,
      formatDate // Make formatDate function available to the template
    };
  }
};
</script>
