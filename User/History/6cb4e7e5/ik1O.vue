            ...
            <div class="card-body">
                <form @submit.prevent="submitCustomer">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6">
                            <!-- Update Button -->
                            <button type="button" class="btn btn-primary" @click="updateCustomerOnSubmit(customer.id)">Save-Update</button>
                        ...
                        <tbody>
                            <tr v-for="(customer, index) in customers" :key="index">
                                ...
                                <td>
                                    ...
                                    <button @click="updateCustomerForm(customer)" class="btn btn-primary">Update</button>
...
export default {
    ...
    customer.id = customerData.id; // Set the id of the customer
