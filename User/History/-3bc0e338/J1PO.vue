          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="tel" id="phoneNumber" v-model="entity.phoneNumber" class="form-control" required>
              </div>
            </div>
          </div>
          <div class="row mt-3">
            <div class="col-md-12 d-flex justify-content-between">
              <button type="submit" class="btn btn-primary" @click="submitEntity">Add Entity</button>
              <!-- Update button placed inline with Add button -->
              <button type="button" class="btn btn-primary" @click="updateEntity">Update</button>
            </div>
          </div>
        </form>
      </div>
